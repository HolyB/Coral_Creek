...
CREATE TABLE IF NOT EXISTS scan_results (
    ...
    adx REAL,
    volatility REAL,
    is_heima BOOLEAN DEFAULT FALSE,
    is_juedi BOOLEAN DEFAULT FALSE,
    heima_daily BOOLEAN DEFAULT FALSE,
    heima_weekly BOOLEAN DEFAULT FALSE,
    heima_monthly BOOLEAN DEFAULT FALSE,
    juedi_daily BOOLEAN DEFAULT FALSE,
    juedi_weekly BOOLEAN DEFAULT FALSE,
    juedi_monthly BOOLEAN DEFAULT FALSE,
    strat_d_trend BOOLEAN DEFAULT FALSE,
    strat_c_resonance BOOLEAN DEFAULT FALSE,
    legacy_signal BOOLEAN DEFAULT FALSE,
    regime VARCHAR(50),

...
if __name__ == "__main__":
    ...
    parser.add_argument("--recent-days", type=int, default=9999, help="回填最近N个扫描交易日 (9999=全量)")
    parser.add_argument("--max-per-day", type=int, default=1200)
    parser.add_argument("--refresh-rows", type=int, default=50000)
